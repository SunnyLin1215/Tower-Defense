...
void StageSelectScene::Initialize() {
    ...
    //owo
    //Engine::ImageButton* btn;
    btn = new Engine::ImageButton("win/dirt.png", "win/floor.png", w-300 , halfH * 7 / 4 - 45, 130, 50);
    btn->SetOnClickCallback(std::bind(&StageSelectScene::BackOnClick, this, 2));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Setting", "pirulen.ttf", 20, w-240 , halfH * 7 / 4 - 25, 0, 0, 0, 250, 0.5, 0.5));
}
