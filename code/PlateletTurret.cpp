...
const int PlateletTurret::Price = 75;
PlateletTurret::PlateletTurret(float x, float y) :
	Turret("play/turret-2.png", x, y, 15, Price, 0.5, 10) {
...
void PlateletTurret::CreateBullet() {
	...
	getPlayScene()->EffectGroup->AddNewObject(new ShootEffect((Position + normalized * 36).x + 40, (Position + normalized* 36).y));
